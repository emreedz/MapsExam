package com.emre.javamapsexamp.adapter;
...
import com.emre.javamapsexamp.databinding.RecyclerRowBinding;
import com.emre.javamapsexamp.model.place;
import com.emre.javamapsexamp.view.MapsActivity;
...
public class PlaceAdapter extends RecyclerView.Adapter<PlaceAdapter.PlaceHolder> {
    ...
    public PlaceHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        RecyclerRowBinding rycRowBinding = RecyclerRowBinding.inflate(
                LayoutInflater.from(parent.getContext()), parent, false);

        return new PlaceHolder(rycRowBinding);
    }
